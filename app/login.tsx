...
import { StyleSheet, TouchableOpacity, View, Image, KeyboardAvoidingView, Platform, ScrollView, Linking } from 'react-native';
        ...
        <ThemedView style={[
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.termsContainer}>
              <Checkbox onChange={setAcceptedTerms} value={"true"} size="sm" isInvalid={false} isDisabled={false}>
                <CheckboxIndicator>
                  <CheckboxIcon as={CheckIcon} />
                </CheckboxIndicator>
                <CheckboxLabel><Text size="sm">
                  I accept the{' '}
                  <Text
                    size="sm"
